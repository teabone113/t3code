import { ProviderKind, type ProviderKind as ProviderKindType, type ThreadId } from "@t3tools/contracts";
...
function decodeProviderKind(
  providerName: string,
  operation: string,
): Effect.Effect<ProviderKindType, ProviderSessionDirectoryPersistenceError> {
